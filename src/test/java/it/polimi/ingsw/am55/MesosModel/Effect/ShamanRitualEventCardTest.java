...
//per controllare i casi di n massimi o n minimi:
        Player doubleminimum = new Player("DoubleMinimum", "red", "summary");
        doubleminimum.addPP(10);
        doubleminimum.addTribeCard(new Shaman(7, 1, 1));

        Player doublemax = new Player("DoubleMax", "red", "summary");
        doublemax.addPP(10);
